...
* To build new cluster applications without having to reinvent low-level facilities for farming out tasks to different nodes, monitoring them, etc, and have your frameworks coexist with existing ones.
...
* [[Framework development guide]] -- learn how to build applications on top of Mesos.
