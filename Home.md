...
* Python 2.6 (for the Mesos web UI)
  * NOTE: On Mac OS X 10.6 or earlier, get Python from [MacPorts](http://www.macports.org/) via `port install python2.6`, because the OS X version of Python is not 64-bit.
