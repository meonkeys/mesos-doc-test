...
We are actively working on our first official Apache release. Currently, you can obtain Mesos (the current development HEAD) by checking it out from either the Apache SVN or Apache Git repository (they are mirrors of each other)
...
NOTE: For alpha version 0.4 and before: download tagged "alpha releases" from github via the [[tags page|https://github.com/mesos/mesos/tags]]
