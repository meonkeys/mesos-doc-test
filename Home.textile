...
Once you have run this test, you will probably want to set up a larger cluster. You can use the included [[deploy scripts]] to launch a cluster on a set of machines you own, or Mesos's [[EC2 scripts]] to bring up a cluster on Amazon EC2.
