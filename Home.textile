...
You can obtain Mesos in two ways:
# By downloading a tagged "release" from the [[tags page|https://github.com/mesos/mesos/tags]]
# By checking it out from the Apache SVN repository using @svn co https://svn.apache.org/repos/asf/incubator/mesos/trunk mesos-trunk@ or from the mirror Apache git repository using @git clone git://git.apache.org/mesos.git@.
