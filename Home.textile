...
Go to "mesosproject.org":http://mesosproject.org to see a list of common usage scenarios and features of Mesos.
...
** [[Using Mesos Amazon Machine Images (AMIs)]] -- How bring up EC2 instances that already have Mesos a master or slave daemon installed and running.
