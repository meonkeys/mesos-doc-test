...
# Run the C++ test framework (a sample that just executes five tasks on the cluster) using @bin/examples/cpp-test-framework [URL of master]@. It should successfully finish after running five tasks.
