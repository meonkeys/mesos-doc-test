...
Once you have run these basic tests, you can use Mesos's [[deploy scripts]] to set up a cluster on a set of nodes, or its [[EC2 scripts]] to launch a cluster on Amazon EC2.
