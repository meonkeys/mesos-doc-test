...
The Git repository contains configure template scripts with the right paths for Mac OS X and several Linux distributions (named @configure.template.*@). These still assume that you have installed the correct packages (e.g. @python-dev@ and the JDK).
