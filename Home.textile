...
* Efficient fine-grained resource sharing mechanism ("[[resource offers|Mesos architecture]]") that allows data-intensive frameworks like Hadoop to achieve high data locality.
