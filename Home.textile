...
h1. Setting up a Mesos Cluster

You can use Mesos's [[deploy scripts]] to launch a cluster on a set of nodes, or its [[EC2 scripts]] to launch a Mesos cluster on Amazon EC2.
