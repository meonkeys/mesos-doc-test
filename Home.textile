...
h1. Logging and Debugging

Mesos uses "Google Log":http://code.google.com/p/google-glog and writes logs to @MESOS_HOME/logs@ by default, where @MESOS_HOME@ is the location where Mesos is installed. The log directory can be [[ Configuration|configured ]] using the @log_dir@ parameter.
...
* [[ Configuration|Mesos configuration ]]
