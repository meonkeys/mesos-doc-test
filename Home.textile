...
The Git repository contains sample configure scripts for Mac OS X and several recent Linux distributions, with the correct paths for each platform. These assume that you have installed the correct packages (e.g. @python-dev@ and the JDK on Linux).
