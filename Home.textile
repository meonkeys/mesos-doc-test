...
* @--with-zookeeper=DIR@ or @--with-included-zookeeper@: Enable master fault-tolerance using an existing ZooKeeper installation or the version of ZooKeeper bundled with Mesos. For details, see "running Mesos with ZooKeeper":https://github.com/mesos/mesos/wikis/running-mesos-with-zookeeper.
...
Once you have run these basic tests, you can use Mesos's [[deploy scripts]] to launch a cluster on a set of nodes, or its [[EC2 scripts]] to launch a cluster on Amazon EC2.
...
** [[Using ZooKeeper|Running Mesos with ZooKeeper]] for master fault-tolerance.
