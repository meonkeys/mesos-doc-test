...
Mesos runs on Linux and [[[[Running Mesos On Mac OS X (Single Node Cluster)]]]], and has previously also been tested on OpenSolaris. You will need the following packages to run it:
