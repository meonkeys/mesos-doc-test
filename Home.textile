...
The Git repository contains configure templates with the right paths for OS X and several Linux distributions (e.g. @configure.template.macosx@). These still assume that you have installed the correct packages (e.g. @python-dev@ and the JDK).
