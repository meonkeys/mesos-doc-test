...
h1. Step-by-Step Guide of Running Mesos
* [[Running Mesos On Mac OS X (Single Node Cluster)]]
* [[Running Mesos On Ubuntu Linux (Single Node Cluster)]]

h1. System Requirements

Mesos runs on Linux and "Mac OS X":https://github.com/mesos/mesos/wiki/Running-Mesos-On-Mac-OS-X-(Single-Node-Cluster), and has previously also been tested on OpenSolaris. You will need the following packages to run it:
